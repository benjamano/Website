...
def onStart():
    try:
        ...
        tblPartyType = "CREATE TABLE IF NOT EXISTS PartyType (PartyTypeID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, Name TEXT NOT NULL, Price per Child DECIMAL(5,2) NOT NULL, Price per Adult DECIMAL(5,2) NOT NULL, Duration INTEGER NOT NULL, LasertagTime TEXT))"
